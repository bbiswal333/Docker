...
function GetTriggerFile {
  ...
  GithubURL='https://github.wdf.sap.corp/raw/I313177/Docker/master/Redhat/build/Hana-XSA/hana-xsa/jenkins'
...
if ! curl -s -k https://github.wdf.sap.corp/raw/I313177/Docker/master/Redhat/build/Hana-XSA/hana-xsa/build/Dockerfile -o build/Dockerfile; then
